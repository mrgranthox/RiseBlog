    ...
    >
      {[
        ...
        <motion.div
          ...
          className={`absolute ${
            circle.top !== undefined ? "top-0" : "bottom-0"
          } ${circle.left !== undefined ? "left-0" : "right-0"} ${
            circle.size
          } translate-x-${circle.x} translate-y-${circle.y}`}
        >
      ...
      <div className="container mx-auto">
        ...
        {postLists ? (
          ...
          <p className="text-lg text-white flex align-center justify-center">
        ...
        {postLists ? (
            ...
            {bestPosts.map((post, idx) => (
              ...
              >
                <div className="relative flex-grow">
                  ...
                  <div
                    className={`absolute bottom-3 left-3 ${getCategoryColor(
                      post.category
                    )} text-white rounded-md px-3 py-1 text-xs`}
                  >
                    {post.tags}
                  </div>
                </div>
          ...
          <p className="text-lg text-white font-base flex align-center justify-center">
