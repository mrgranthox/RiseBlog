...
const VerifyAccount = () => { 
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const { data } = await axiosInstance.post( '/auth/user/verify-account', { otp })
...
return (
    ...
    <div className="mb-6">
      ...
      <h2 className="text-3xl font-extrabold text-center text-gray-800 mb-3">Verify Your Account</h2>       
        <p className='text-center mb-8 text-gray-500'>Enter the Otp sent to mailbox</p>
