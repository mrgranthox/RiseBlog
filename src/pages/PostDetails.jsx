...
const PostDetails = () => {
  ...
  if (!post) return <div className="flex justify-center items-center text-center py-20 text-gray-500">Loading post...</div>;
      ...
      <div className="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-4 gap-6 px-3 pt-8 mb-16">
        ...
        >
          <div className="flex items-center gap-4 mb-6">
            ...
            />
            <div>
              <p className="text-gray-800 font-semibold">{post.author?.name || 'Unknown'}</p>
  ...
  {/* Recommended Users */}
  <div className="bg-white p-6 rounded-2xl shadow-md w-full">
    <h3 className="text-xl font-semibold text-gray-800 mb-4">👥 Recommended Users</h3>
